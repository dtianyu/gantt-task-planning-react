## 在gantt-task-react基础上进行了调整，加入ProductionPlanning相关属性
...
```
npm install gantt-task-planning-react
```

## How to use it
## gantt-task-react组件保持不变，用法参考

```javascript
import { Gantt, Task, EventOption, StylingOption, ViewMode, DisplayOption } from 'gantt-task-planning-react';
import "gantt-task-planning-react/dist/index.css";
