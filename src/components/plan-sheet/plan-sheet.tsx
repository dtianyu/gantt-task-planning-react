...
export const PlanSheet: React.FunctionComponent<GanttProps> = ({
  tasks,
  headerHeight = 50,
  columnWidth = 60,
  listCellWidth = "155px",
  ...
  const barProps: PlanGanttContentProps = {
    tasks: barTasks,
    dates: dateSetup.dates,
    ganttEvent,
    selectedTask,
  ...
  const tableProps: PlanListProps = {
    rowHeight,
    ...
    PlanListHeader: TaskListHeader,
    PlanListTable: TaskListTable,
  };
  return (
    <div>
      <div
        ...
        ref={wrapperRef}
      >
        {listCellWidth && <PlanList {...tableProps} />}
        <PlanGantt
          gridProps={gridProps}
